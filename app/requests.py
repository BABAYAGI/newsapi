...
def search_country(country):
    search_country_url = 'https://newsapi.org/v2/top-headlines?country={}&apiKey={}'.format(
        country, api_key)
...
def get_business_category():
    ...
    business_url = 'https://newsapi.org/v2/top-headlines?category=business&apiKey={}'.format(
        api_key)
    ...
    with urllib.request.urlopen(business_url) as url:
        ...
        if business_category_response['articles']:
            ...
            business_category_results = process_results(
...
def get_entertainment_category():
    ...
    entertainment_url = 'https://newsapi.org/v2/top-headlines?category=entertainment&apiKey={}'.format(
        api_key)

    with urllib.request.urlopen(entertainment_url) as url:
        entertainment_category_data = url.read()
        entertainment_category_response = json.loads(
            entertainment_category_data)
        ...
        if entertainment_category_response['articles']:
            ...
            entertainment_category_results = process_results(
...
def get_general_category():
    ...
    general_url = 'https://newsapi.org/v2/top-headlines?category=general&apiKey={}'.format(
        api_key)
    ...
    with urllib.request.urlopen(general_url) as url:
        ...
        if general_category_response['articles']:
            ...
            general_category_results = process_results(
...
def get_health_category():
    ...
    health_url = 'https://newsapi.org/v2/top-headlines?category=health&apiKey={}'.format(
        api_key)
...
def get_technology_category():
    ...
    technology_url = 'https://newsapi.org/v2/top-headlines?category=technology&apiKey={}'.format(
        api_key)
    ...
    with urllib.request.urlopen(technology_url) as url:
        ...
        if technology_category_response['articles']:
            ...
            technology_category_results = process_results(
...
def get_newsid(id):
    article_url = "https://newsapi.org/v2/everything?q={}&apiKey=c71bc376a4984584b138047007ed8637".format(
        id)
